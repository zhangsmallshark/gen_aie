  ...
  chess_loop_range(R_A,)
  {
    ...
    chess_loop_range(kColTilesB,)
    {
      ...
      chess_loop_range(kColTilesA,)
      {
        ...
        buf_mat_b = window_readincr_v8(top);
        acc0 = fpmac(acc0, xset_w(0, buf_mat_a), 1, 0x00000000, buf_mat_b, 0, 0x76543210);
        buf_mat_b = window_readincr_v8(top);
        acc0 = fpmac(acc0, xset_w(0, buf_mat_a), 2, 0x00000000, buf_mat_b, 0, 0x76543210);
        buf_mat_b = window_readincr_v8(top);
        acc0 = fpmac(acc0, xset_w(0, buf_mat_a), 3, 0x00000000, buf_mat_b, 0, 0x76543210);
        buf_mat_b = window_readincr_v8(top);
        acc0 = fpmac(acc0, xset_w(0, buf_mat_a), 4, 0x00000000, buf_mat_b, 0, 0x76543210);
        buf_mat_b = window_readincr_v8(top);
        acc0 = fpmac(acc0, xset_w(0, buf_mat_a), 5, 0x00000000, buf_mat_b, 0, 0x76543210);
        buf_mat_b = window_readincr_v8(top);
        acc0 = fpmac(acc0, xset_w(0, buf_mat_a), 6, 0x00000000, buf_mat_b, 0, 0x76543210);
        buf_mat_b = window_readincr_v8(top);
        acc0 = fpmac(acc0, xset_w(0, buf_mat_a), 7, 0x00000000, buf_mat_b, 0, 0x76543210);
      }
